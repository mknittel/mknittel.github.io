...
<a class="sumToggle"><small>Summary</small></a>, <small>[PDF](https://mknittel.github.io/files/Christia_et_al_AAAI_2021.pdf) <div class="summary"></div></small>
<script>
    document .querySelector(".sumToggle") .addEventListener("click", toggleText);
    function toggleText() {
        var x = document.querySelector(".summary");
        if (x.innerHTML === "") {
            x.innerHTML = "<br/>Testt";
        } else {
            x.innerHTML = "";
        }
    }
