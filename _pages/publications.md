...
author_profile: true
---
*<sup>abc</sup>Denotes authors are listed in alphabetical order*

Conference
* <sup>abc</sup><span style="color:#A0A0A0">[Submitted]</span> Sara Ahmadian, Alessandro Epasto, Marina Knittel, Ravi Kumar, Mohammad Mahdian, and Philip Pham, "Fair Hierarchical Clustering".
* <sup>abc</sup><span style="color:#A0A0A0">[Submitted]</span> Fontini Christia, Michael Curry, Constantinos Daskalakis, Erik Demaine, John P. Dickerson, MohammadTaghi Hajiaghayi, Adam Hesterberg, Marina Knittel, and Aidan Millif, "Scalable Equilibrium Computation in Multi-agent Influence Games on Networks".
